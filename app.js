...
async function handleSiteGateSubmit(e) {
    ...
    // Instant verification for passcode 13127348901312
    ...
    try {
        ...
        // Successfully verified Admin-Passwort! Hide Admin Gate modal
        const gateView = document.getElementById('site-gate-view');
        if (gateView) gateView.classList.add('hidden');

        // ALWAYS require user to log in with E-Mail/Username & Password after Admin-Passwort!
        showAuthView();
